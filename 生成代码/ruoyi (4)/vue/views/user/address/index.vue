<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="默认地址标记" prop="isDefault">
        <el-input
          v-model="queryParams.isDefault"
          placeholder="请输入默认地址标记"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="addressList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="收件人姓名" align="center" prop="recipient" />
      <el-table-column label="联系电话" align="center" prop="phone" />
      <el-table-column label="详细地址" align="center" prop="address" />
      <el-table-column label="默认地址标记" align="center" prop="isDefault" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="默认地址标记" prop="isDefault">
          <el-input v-model="form.isDefault" placeholder="请输入默认地址标记" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('user/address/export', {
        ...this.queryParams
